        ...
        <section className="feature">
            <div className="feature-content grid">
                ...
                <div className="feature-right">
                    <img className="feature-img img" width="100%" height="auto" src="https://res.cloudinary.com/drbu50m1e/image/upload/v1680000172/react-static-page/thomas-yohei-BAlBUJb-SXQ-unsplash_dfnvfb.jpg" alt="thomas-yohei-BAlBUJb-SXQ-unsplash_dfnvfb" />
                </div>
            </div>
        </section>
    )
