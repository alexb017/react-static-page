    ...
    return (
        <section className="main-outro">
            <div className="container">
                <div className="outro">
                    <div className="outro-content grid">
                        <div className="outro-text grid-col-13">
                            <animated.h1 className="outro-h1" style={h1} ref={ref}>It's time to <span>ignite</span> your energy</animated.h1>
