...
export default function Unique() {
    ...
    return (
        <section className="main-unique">
            <div className="container">
                <div className="unique">
                    <animated.div className="unique-content grid" style={element} ref={ref}>
                        <h2 className="unique-h2 grid-col-13">One <span className="span-1">unique</span> feature of Fitr is its social aspect, allowing users to connect with <span className="span-2">friends</span> and other users for added <span className="span-3">motivation</span> and <span className="span-4">support</span>.</h2>
                        <hr />
                        <button type="button" className="btn-apple grid-col-13">
