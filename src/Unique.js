        ...
        <section className="main-unique">
            <div className="container">
                <div className="unique">
                    <div className="unique-content grid">
                        <h2 className="unique-h2">One <span className="span-1">unique</span> feature of Fitr is its social aspect, allowing users to connect with <span className="span-2">friends</span> and other users for added <span className="span-3">motivation</span> and <span className="span-4">support</span>.</h2>
                        <hr />
